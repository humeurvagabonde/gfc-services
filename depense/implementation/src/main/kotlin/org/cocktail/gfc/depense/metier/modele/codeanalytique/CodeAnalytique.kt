...
import org.cocktail.gfc.admin.nomenclature.codeanalytique.org.cocktail.gfc.depense.metier.modele.codeanalytique.CodeAnalytique;
...
public class QueryDSLCodeAnalytiqueRepository extends SequenceRepository4 implements CodeAnalytiqueRepository {
    ...
    @Override
    public List<org.cocktail.gfc.depense.metier.modele.codeanalytique.CodeAnalytique> findAll() {
    ...
    @Override
    public List<org.cocktail.gfc.depense.metier.modele.codeanalytique.CodeAnalytique> findOuvertsEtPourPersId(EjId ejId, CktlGFCDate dateEj, PersonneId personneId) {
        return qf.select(projection)
                .from(admCodeAnalytique)
    ...
    public class Projection extends MappingProjection<org.cocktail.gfc.depense.metier.modele.codeanalytique.CodeAnalytique> {

        private static final long serialVersionUID = 1L;

        public Projection() {
            super(org.cocktail.gfc.depense.metier.modele.codeanalytique.CodeAnalytique.class, admCodeAnalytique.all());
        }

        @Override
        protected org.cocktail.gfc.depense.metier.modele.codeanalytique.CodeAnalytique map(Tuple row) {
            return org.cocktail.gfc.depense.metier.modele.codeanalytique.CodeAnalytique.builder()
