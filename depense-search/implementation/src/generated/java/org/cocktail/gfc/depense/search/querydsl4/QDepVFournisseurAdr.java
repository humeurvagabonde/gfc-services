...
/**
 * QDepVFournisseurAdr is a Querydsl query type for QDepVFournisseurAdr
 */
@Generated("com.querydsl.sql.codegen.MetaDataSerializer")
public class QDepVFournisseurAdr extends com.querydsl.sql.RelationalPathBase<QDepVFournisseurAdr> {

    private static final long serialVersionUID = 325107103;

    public static final QDepVFournisseurAdr depVFournisseurAdr = new QDepVFournisseurAdr("DEP_V_FOURNISSEUR_ADR");
    ...
    public QDepVFournisseurAdr(String variable) {
        super(QDepVFournisseurAdr.class, forVariable(variable), "GFC", "DEP_V_FOURNISSEUR_ADR");
        addMetadata();
    }

    public QDepVFournisseurAdr(String variable, String schema, String table) {
        super(QDepVFournisseurAdr.class, forVariable(variable), schema, table);
        addMetadata();
    }

    public QDepVFournisseurAdr(Path<? extends QDepVFournisseurAdr> path) {
        super(path.getType(), path.getMetadata(), "GFC", "DEP_V_FOURNISSEUR_ADR");
        addMetadata();
    }

    public QDepVFournisseurAdr(PathMetadata metadata) {
        super(QDepVFournisseurAdr.class, metadata, "GFC", "DEP_V_FOURNISSEUR_ADR");
        addMetadata();
    }
